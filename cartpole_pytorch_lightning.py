...
class Agent:
    ...
    def reset(self) -> None:
        """Resets the environment and updates the state. This should be called when an episode is done"""
    ...
    def get_action(self, net: nn.Module, epsilon: float, device: str) -> int:
        ...
        Args:
            net: DQN network
            epsilon: value to determine probability of taking a random action
